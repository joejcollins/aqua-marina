...
<script>
    ...
    var runLayer = omnivore.gpx('https://raw.githubusercontent.com/joejcollins/aqua-marina/master/data/raw/spains-hall-waypoints-regular-30m-with-name-edited.gpx')
    .on('ready', function() {
